...
curl --location --request PUT 'https://h45evhjgs3.execute-api.us-east-1.amazonaws.com/dev/loveisair/test_res.tar.gz' --header 'Content-Type: application/gzip' --data-binary @${curr_path}/$1.tar.gz
